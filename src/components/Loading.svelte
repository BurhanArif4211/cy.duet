<script>
  ...
  // Props
  export let logo = 'https://pub-b3589ba545114fce92da1edaa54f8cfd.r2.dev/static/cy-logo.png';       // path to your logo image
...
{#if visible}
  ...
  >
    <!-- Pulsing accent ring -->
    <div class="absolute w-24 h-24 md:w-42 md:h-42 sm:w-62 sm:h-62 rounded-full border-2 border-[#4B338C]/30 animate-ping"></div>
    <div class="absolute w-24 h-24 md:w-42 md:h-42 sm:w-62 sm:h-62 rounded-full border border-[#4B338C]/50"></div>
